...
function ContactForm() {
  ...
  const handleSendMail = async (e) => {
    ...
    try {
      ...
      // alert("API error:", error); // 🔴 Show full error
  ...
  return (
    <div className="">
      ...
      <div className="max-w-3xl text-white rounded-lg border border-[0.5px] p-3 lg:p-5 bg-[url('/contact.webp')] bg-cover bg-center p-10">
